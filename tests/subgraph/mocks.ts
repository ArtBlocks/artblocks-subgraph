...
let coreContractAddress = Address.fromString(
...
export const mockProjectContractCalls = function(): void {
  ...
  let projectTokenInfoReturnArray: Array<ethereum.Value> = [
    ...
    ethereum.Value.fromAddress(
      Address.fromString("0xc079F0A6E8809E41A2A39D6532ff3dfa6B48e6bB")
    ), // additionalPayee
    ethereum.Value.fromSignedBigInt(BigInt.fromString("10")), // additionalPayeePercentage
    ethereum.Value.fromString("GRT"), // currency
    ethereum.Value.fromAddress(
      Address.fromString("0xc944e90c64b2c07662a292be6244bdf05cda44a7")
    )
  ]; // currencyAddress
  createMockedFunction(
    coreContractAddress,
...
export const mockOGProjectContractCalls = function(): void {
  ...
  let projectTokenInfoReturnArray: Array<ethereum.Value> = [
    ...
    ethereum.Value.fromSignedBigInt(BigInt.fromString("10"))
...
export const createProjectToLoad = function(): void {
  ...
  newProjectCall.to = Address.fromString(
    "0xa7d8d9ef8D8Ce8992Df33D8b8CF4Aebabd5bD270"
  ); // must be 721Core?
