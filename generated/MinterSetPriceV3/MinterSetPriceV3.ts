...
export class MinterSetPriceV3__getPriceInfoResult {
  value0: boolean;
  value1: BigInt;
  value2: string;
  value3: Address;
...
export class MinterSetPriceV3__projectConfigResult {
  value0: boolean;
  value1: boolean;
  value2: i32;
  value3: BigInt;
...
export class MinterSetPriceV3 extends ethereum.SmartContract {
  static bind(address: Address): MinterSetPriceV3 {
    return new MinterSetPriceV3("MinterSetPriceV3", address);
  }
  ...
  getPriceInfo(_projectId: BigInt): MinterSetPriceV3__getPriceInfoResult {
    let result = super.call(
      "getPriceInfo",
    ...
    return new MinterSetPriceV3__getPriceInfoResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toString(),
      result[3].toAddress()
  ...
  try_getPriceInfo(
    _projectId: BigInt
  ): ethereum.CallResult<MinterSetPriceV3__getPriceInfoResult> {
    let result = super.tryCall(
      "getPriceInfo",
      "getPriceInfo(uint256):(bool,uint256,string,address)",
      [ethereum.Value.fromUnsignedBigInt(_projectId)]
    ...
    return ethereum.CallResult.fromValue(
      new MinterSetPriceV3__getPriceInfoResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toString(),
        value[3].toAddress()
  ...
  projectConfig(param0: BigInt): MinterSetPriceV3__projectConfigResult {
    let result = super.call(
      "projectConfig",
    ...
    return new MinterSetPriceV3__projectConfigResult(
      result[0].toBoolean(),
      result[1].toBoolean(),
      result[2].toI32(),
      result[3].toBigInt()
  ...
  try_projectConfig(
    param0: BigInt
  ): ethereum.CallResult<MinterSetPriceV3__projectConfigResult> {
    let result = super.tryCall(
      "projectConfig",
      "projectConfig(uint256):(bool,bool,uint24,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new MinterSetPriceV3__projectConfigResult(
        value[0].toBoolean(),
        value[1].toBoolean(),
        value[2].toI32(),
        value[3].toBigInt()
