...
export class Project extends Entity {
  constructor(id: string) {
    ...
    this.set("externalAssetDependencyCount", Value.fromBigInt(BigInt.zero()));
    this.set("externalAssetDependenciesLocked", Value.fromBoolean(false));
...
export class ProposedArtistAddressesAndSplit extends Entity {
  ...
  save(): void {
    ...
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        "Cannot save ProposedArtistAddressesAndSplit entity with non-string ID. " +
          'Considering using .toHex() to convert the "id" to a string.'
      );
...
export class Contract extends Entity {
  constructor(id: string) {
    ...
    this.set("createdAt", Value.fromBigInt(BigInt.zero()));
    this.set("updatedAt", Value.fromBigInt(BigInt.zero()));
    this.set("newProjectsForbidden", Value.fromBoolean(false));
  }
...
export class ProjectExternalAssetDependency extends Entity {
  constructor(id: string) {
    ...
    this.set("project", Value.fromString(""));
    this.set("dependencyType", Value.fromString(""));
  ...
  save(): void {
    ...
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        "Cannot save ProjectExternalAssetDependency entity with non-string ID. " +
          'Considering using .toHex() to convert the "id" to a string.'
      );
