...
export class WyvernExchangeWithBulkCancellations extends ethereum.SmartContract {
  static bind(address: Address): WyvernExchangeWithBulkCancellations {
    return new WyvernExchangeWithBulkCancellations(
