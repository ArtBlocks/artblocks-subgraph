...
export class MinterDAExpV2__getPriceInfoResult {
  value0: boolean;
  value1: BigInt;
  value2: string;
  value3: Address;
...
export class MinterDAExpV2__projectAuctionParametersResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class MinterDAExpV2__projectConfigResult {
  value0: boolean;
  value1: i32;
  value2: BigInt;
  value3: BigInt;
...
export class MinterDAExpV2 extends ethereum.SmartContract {
  static bind(address: Address): MinterDAExpV2 {
    return new MinterDAExpV2("MinterDAExpV2", address);
  }
  ...
  getPriceInfo(_projectId: BigInt): MinterDAExpV2__getPriceInfoResult {
    let result = super.call(
      "getPriceInfo",
    ...
    return new MinterDAExpV2__getPriceInfoResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toString(),
      result[3].toAddress()
  ...
  try_getPriceInfo(
    _projectId: BigInt
  ): ethereum.CallResult<MinterDAExpV2__getPriceInfoResult> {
    let result = super.tryCall(
      "getPriceInfo",
      "getPriceInfo(uint256):(bool,uint256,string,address)",
      [ethereum.Value.fromUnsignedBigInt(_projectId)]
    ...
    return ethereum.CallResult.fromValue(
      new MinterDAExpV2__getPriceInfoResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toString(),
        value[3].toAddress()
  ...
  projectAuctionParameters(
    _projectId: BigInt
  ): MinterDAExpV2__projectAuctionParametersResult {
    let result = super.call(
      "projectAuctionParameters",
    ...
    return new MinterDAExpV2__projectAuctionParametersResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_projectAuctionParameters(
    _projectId: BigInt
  ): ethereum.CallResult<MinterDAExpV2__projectAuctionParametersResult> {
    let result = super.tryCall(
      "projectAuctionParameters",
      "projectAuctionParameters(uint256):(uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(_projectId)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new MinterDAExpV2__projectAuctionParametersResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  projectConfig(param0: BigInt): MinterDAExpV2__projectConfigResult {
    let result = super.call(
      "projectConfig",
    ...
    return new MinterDAExpV2__projectConfigResult(
      result[0].toBoolean(),
      result[1].toI32(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_projectConfig(
    param0: BigInt
  ): ethereum.CallResult<MinterDAExpV2__projectConfigResult> {
    let result = super.tryCall(
      "projectConfig",
      "projectConfig(uint256):(bool,uint24,uint64,uint64,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new MinterDAExpV2__projectConfigResult(
        value[0].toBoolean(),
        value[1].toI32(),
        value[2].toBigInt(),
        value[3].toBigInt(),
