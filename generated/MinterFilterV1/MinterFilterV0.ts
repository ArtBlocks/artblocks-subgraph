...
export class IsCanonicalMinterFilter extends ethereum.Event {
  get params(): IsCanonicalMinterFilter__Params {
    return new IsCanonicalMinterFilter__Params(this);
  }
}

export class IsCanonicalMinterFilter__Params {
  _event: IsCanonicalMinterFilter;

  constructor(event: IsCanonicalMinterFilter) {
    this._event = event;
  }
...
export class MinterFilterV0__getProjectAndMinterInfoAtResult {
  value0: BigInt;
  value1: Address;
  value2: string;
...
export class MinterFilterV0 extends ethereum.SmartContract {
  static bind(address: Address): MinterFilterV0 {
    return new MinterFilterV0("MinterFilterV0", address);
  }
  ...
  getProjectAndMinterInfoAt(
    _index: BigInt
  ): MinterFilterV0__getProjectAndMinterInfoAtResult {
    let result = super.call(
      "getProjectAndMinterInfoAt",
    ...
    return new MinterFilterV0__getProjectAndMinterInfoAtResult(
      result[0].toBigInt(),
      result[1].toAddress(),
      result[2].toString()
    );
  ...
  try_getProjectAndMinterInfoAt(
    _index: BigInt
  ): ethereum.CallResult<MinterFilterV0__getProjectAndMinterInfoAtResult> {
    let result = super.tryCall(
      "getProjectAndMinterInfoAt",
      "getProjectAndMinterInfoAt(uint256):(uint256,address,string)",
      [ethereum.Value.fromUnsignedBigInt(_index)]
    ...
    return ethereum.CallResult.fromValue(
      new MinterFilterV0__getProjectAndMinterInfoAtResult(
        value[0].toBigInt(),
        value[1].toAddress(),
        value[2].toString()
      )
...
export class AlertAsCanonicalMinterFilterCall extends ethereum.Call {
  get inputs(): AlertAsCanonicalMinterFilterCall__Inputs {
    return new AlertAsCanonicalMinterFilterCall__Inputs(this);
  }

  get outputs(): AlertAsCanonicalMinterFilterCall__Outputs {
    return new AlertAsCanonicalMinterFilterCall__Outputs(this);
  }
}

export class AlertAsCanonicalMinterFilterCall__Inputs {
  _call: AlertAsCanonicalMinterFilterCall;

  constructor(call: AlertAsCanonicalMinterFilterCall) {
    this._call = call;
  }
}

export class AlertAsCanonicalMinterFilterCall__Outputs {
  _call: AlertAsCanonicalMinterFilterCall;
