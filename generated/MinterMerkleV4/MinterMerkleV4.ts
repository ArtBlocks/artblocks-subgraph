...
export class MinterMerkleV4__getPriceInfoResult {
  value0: boolean;
  value1: BigInt;
  value2: string;
  value3: Address;
...
export class MinterMerkleV4__projectConfigResult {
  value0: boolean;
  value1: boolean;
  value2: boolean;
  value3: i32;
...
export class MinterMerkleV4__projectRemainingInvocationsForAddressResult {
  value0: boolean;
  value1: BigInt;
...
export class MinterMerkleV4 extends ethereum.SmartContract {
  static bind(address: Address): MinterMerkleV4 {
    return new MinterMerkleV4("MinterMerkleV4", address);
  }
  ...
  getPriceInfo(_projectId: BigInt): MinterMerkleV4__getPriceInfoResult {
    let result = super.call(
      "getPriceInfo",
    ...
    return new MinterMerkleV4__getPriceInfoResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toString(),
      result[3].toAddress()
  ...
  try_getPriceInfo(
    _projectId: BigInt
  ): ethereum.CallResult<MinterMerkleV4__getPriceInfoResult> {
    let result = super.tryCall(
      "getPriceInfo",
      "getPriceInfo(uint256):(bool,uint256,string,address)",
      [ethereum.Value.fromUnsignedBigInt(_projectId)]
    ...
    return ethereum.CallResult.fromValue(
      new MinterMerkleV4__getPriceInfoResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toString(),
        value[3].toAddress()
  ...
  projectConfig(param0: BigInt): MinterMerkleV4__projectConfigResult {
    let result = super.call(
      "projectConfig",
    ...
    return new MinterMerkleV4__projectConfigResult(
      result[0].toBoolean(),
      result[1].toBoolean(),
      result[2].toBoolean(),
      result[3].toI32(),
  ...
  try_projectConfig(
    param0: BigInt
  ): ethereum.CallResult<MinterMerkleV4__projectConfigResult> {
    let result = super.tryCall(
      "projectConfig",
      "projectConfig(uint256):(bool,bool,bool,uint24,uint24,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new MinterMerkleV4__projectConfigResult(
        value[0].toBoolean(),
        value[1].toBoolean(),
        value[2].toBoolean(),
        value[3].toI32(),
  ...
  projectRemainingInvocationsForAddress(
    _projectId: BigInt,
    _address: Address
  ): MinterMerkleV4__projectRemainingInvocationsForAddressResult {
    let result = super.call(
      "projectRemainingInvocationsForAddress",
    ...
    return new MinterMerkleV4__projectRemainingInvocationsForAddressResult(
      result[0].toBoolean(),
      result[1].toBigInt()
    );
  }
  ...
  > {
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new MinterMerkleV4__projectRemainingInvocationsForAddressResult(
        value[0].toBoolean(),
        value[1].toBigInt()
      )
    );
