...
export class MinterDAExpV0__getPriceInfoResult {
  value0: boolean;
  value1: BigInt;
  value2: string;
  value3: Address;
...
export class MinterDAExpV0__projectAuctionParametersResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class MinterDAExpV0 extends ethereum.SmartContract {
  static bind(address: Address): MinterDAExpV0 {
    return new MinterDAExpV0("MinterDAExpV0", address);
  }
  ...
  getPriceInfo(_projectId: BigInt): MinterDAExpV0__getPriceInfoResult {
    let result = super.call(
      "getPriceInfo",
    ...
    return new MinterDAExpV0__getPriceInfoResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toString(),
      result[3].toAddress()
  ...
  try_getPriceInfo(
    _projectId: BigInt
  ): ethereum.CallResult<MinterDAExpV0__getPriceInfoResult> {
    let result = super.tryCall(
      "getPriceInfo",
      "getPriceInfo(uint256):(bool,uint256,string,address)",
      [ethereum.Value.fromUnsignedBigInt(_projectId)]
    ...
    return ethereum.CallResult.fromValue(
      new MinterDAExpV0__getPriceInfoResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toString(),
        value[3].toAddress()
  ...
  projectAuctionParameters(
    param0: BigInt
  ): MinterDAExpV0__projectAuctionParametersResult {
    let result = super.call(
      "projectAuctionParameters",
    ...
    return new MinterDAExpV0__projectAuctionParametersResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_projectAuctionParameters(
    param0: BigInt
  ): ethereum.CallResult<MinterDAExpV0__projectAuctionParametersResult> {
    let result = super.tryCall(
      "projectAuctionParameters",
      "projectAuctionParameters(uint256):(uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new MinterDAExpV0__projectAuctionParametersResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
