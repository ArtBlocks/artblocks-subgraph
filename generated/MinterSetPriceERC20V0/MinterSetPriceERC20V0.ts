...
export class MinterSetPriceERC20V0__getPriceInfoResult {
  value0: boolean;
  value1: BigInt;
  value2: string;
  value3: Address;
...
export class MinterSetPriceERC20V0 extends ethereum.SmartContract {
  static bind(address: Address): MinterSetPriceERC20V0 {
    return new MinterSetPriceERC20V0("MinterSetPriceERC20V0", address);
  }
  ...
  getPriceInfo(_projectId: BigInt): MinterSetPriceERC20V0__getPriceInfoResult {
    let result = super.call(
      "getPriceInfo",
    ...
    return new MinterSetPriceERC20V0__getPriceInfoResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toString(),
      result[3].toAddress()
  ...
  try_getPriceInfo(
    _projectId: BigInt
  ): ethereum.CallResult<MinterSetPriceERC20V0__getPriceInfoResult> {
    let result = super.tryCall(
      "getPriceInfo",
      "getPriceInfo(uint256):(bool,uint256,string,address)",
      [ethereum.Value.fromUnsignedBigInt(_projectId)]
    ...
    return ethereum.CallResult.fromValue(
      new MinterSetPriceERC20V0__getPriceInfoResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toString(),
        value[3].toAddress()
