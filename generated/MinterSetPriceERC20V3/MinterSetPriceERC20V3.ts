...
export class MinterSetPriceERC20V3__getPriceInfoResult {
  value0: boolean;
  value1: BigInt;
  value2: string;
  value3: Address;
...
export class MinterSetPriceERC20V3__projectConfigResult {
  value0: boolean;
  value1: boolean;
  value2: i32;
  value3: Address;
...
export class MinterSetPriceERC20V3 extends ethereum.SmartContract {
  static bind(address: Address): MinterSetPriceERC20V3 {
    return new MinterSetPriceERC20V3("MinterSetPriceERC20V3", address);
  }
  ...
  getPriceInfo(_projectId: BigInt): MinterSetPriceERC20V3__getPriceInfoResult {
    let result = super.call(
      "getPriceInfo",
    ...
    return new MinterSetPriceERC20V3__getPriceInfoResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toString(),
      result[3].toAddress()
  ...
  try_getPriceInfo(
    _projectId: BigInt
  ): ethereum.CallResult<MinterSetPriceERC20V3__getPriceInfoResult> {
    let result = super.tryCall(
      "getPriceInfo",
      "getPriceInfo(uint256):(bool,uint256,string,address)",
      [ethereum.Value.fromUnsignedBigInt(_projectId)]
    ...
    return ethereum.CallResult.fromValue(
      new MinterSetPriceERC20V3__getPriceInfoResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toString(),
        value[3].toAddress()
  ...
  projectConfig(param0: BigInt): MinterSetPriceERC20V3__projectConfigResult {
    let result = super.call(
      "projectConfig",
    ...
    return new MinterSetPriceERC20V3__projectConfigResult(
      result[0].toBoolean(),
      result[1].toBoolean(),
      result[2].toI32(),
      result[3].toAddress(),
  ...
  try_projectConfig(
    param0: BigInt
  ): ethereum.CallResult<MinterSetPriceERC20V3__projectConfigResult> {
    let result = super.tryCall(
      "projectConfig",
      "projectConfig(uint256):(bool,bool,uint24,address,uint256,string)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new MinterSetPriceERC20V3__projectConfigResult(
        value[0].toBoolean(),
        value[1].toBoolean(),
        value[2].toI32(),
        value[3].toAddress(),
